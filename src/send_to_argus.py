...
async def send_to_backend(boon_data, weapon_data, familiar_data, keepsake_data, elemental_data, pin_data):
    ...
    sys.stdout.write("Keepsake: " + str(keepsake_data) + "\n")
    ...
    response = requests.post(
        ...
        json = {
            ...
            "runData": {
                ...
                "keepsakeData": keepsake_data.strip(),                        
...
def read_data_from_stdin():
    ...
    keepsake_data = sys.stdin.readline()
    ...
    return boon_data, weapon_data, familiar_data, keepsake_data, elemental_data, pin_data
...
if (len(sys.argv) > 1):
    if sys.argv[1] == "test1":
        ...
        keepsake_data = "NOKEEPSAKES"
        elemental_data = "Fire:0;;Water:0;;Earth:0;;Air:0;;Aether:0"
        pin_data = "NOPINS"
    else:
        boon_data, weapon_data, familiar_data, keepsake_data, elemental_data, pin_data = read_data_from_stdin()
else:
    boon_data, weapon_data, familiar_data, keepsake_data, elemental_data, pin_data = read_data_from_stdin()
asyncio.run(send_to_backend(boon_data, weapon_data, familiar_data, keepsake_data, elemental_data, pin_data))
