...
if __name__ == "__main__":
    arg_parser = argparse.ArgumentParser(
        description="Send Argus data to the Argus backend."
    )
    arg_parser.add_argument(
        "--pluginpath",
        required=True,
        help="Path to the folder in which files should be stored (normally, RoM's plugins_data).",
    )
    arg_parser.add_argument(
        "--login", action="store_true", help="Just do login. No sending."
    )
